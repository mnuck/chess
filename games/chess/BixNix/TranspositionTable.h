...
class TranspositionTable {
 public:
  ...
  bool get(const ZobristNumber key, const unsigned int priority, int& alpha,
           int& beta, int& score);

  bool set(const ZobristNumber key, const int score,
           const unsigned int priority, const int alpha, const int beta);
